...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        foreach ($node->stmts as $key => $stmt) {
            ...
            $matchedNullableVariableNameToTypes = $this->matchNullableVariableNameToTypes(
                $stmt,
            ...
            foreach ($matchedNullableVariableNameToTypes as $matchedNullableVariableNameToType) {
                ...
                $assertInstanceOfExpression = $this->assertMethodCallFactory->createAssertInstanceOf(
     ...
     */
    private function matchNullableVariableNameToTypes(
        Stmt $stmt,
        ...
        $this->traverseNodesWithCallable($stmt, function (Node $node) use (
            ...
            if (in_array($variableName, $matchedVariableNames, true)) {
                return null;
            }
