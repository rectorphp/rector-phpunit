...
final class AddKeysExistsAssertForKeyUseRector extends AbstractRector
{
    public function __construct(
        ...
        private readonly AssertHasKeyMatcher $assertHasKeyMatcher,
        private readonly AssertArrayHasKeyCallFactory $assertArrayHasKeyCallFactory,
    ) {
    }
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?ClassMethod
    {
        ...
        foreach ($node->stmts as $key => $stmt) {
            ...
            $callExpression = $this->assertArrayHasKeyCallFactory->create(
                $assertedExpr->var,
                $assertedExpr->dim,
                $scope
            );
