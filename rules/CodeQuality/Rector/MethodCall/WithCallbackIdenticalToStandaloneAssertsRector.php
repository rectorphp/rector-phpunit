...
final class WithCallbackIdenticalToStandaloneAssertsRector extends AbstractRector
{
    public function __construct(
        private readonly ClosureUsesResolver $closureUsesResolver,
...
CODE_SAMPLE
    ...
    private function resolveInnerReturnJoinedExprs(ArgAndFunctionLike $argAndFunctionLike): array
    {
        ...
        if ($innerSoleExpr instanceof Identical || $innerSoleExpr instanceof Instanceof_ || $innerSoleExpr instanceof Isset_ || ($innerSoleExpr instanceof FuncCall && $this->isName(
            $innerSoleExpr->name,
            'array_key_exists'
