...
CODE_SAMPLE
    ...
    private function createEntitySetterExpressions(Array_ $definedGettersArray, Expr $expr): array
    {
        ...
        foreach ($definedGettersArray->items as $arrayItem) {
            ...
            // remove "get" prefix
            if (! str_starts_with($getterName, 'get')) {
                continue;
            }
    ...
    private function matchDoctrineClassName(Expr $expr): string|null
    {
     ...
     * @return Stmt[]
     */
    private function createForAssign(
        string $doctrineClass,
        Assign $assign,
        Array_ $definedGettersArray,
